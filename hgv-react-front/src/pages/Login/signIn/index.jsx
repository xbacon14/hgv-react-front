  ...
  return (
    <div className="col-4 card-login">
      <div className="card-body align-content-center">
        ...
        <left>
          <div>
            <div className="espacio-error col-12">
              {' '}
              {error && <p className="error slide-in-blurred-left">{error}</p>}
            </div>
          </div>
        </left>
        <form onSubmit={handleSubmit}>
          <left>
            ...
            <h1 className="text-jumbo title-login ">Inicie Sesión</h1>
              <label htmlFor="emailLabel" className="text-title">
                Correo
              </label>
              <input
                type="email"
                required
                className="form-control label-login"
                id="emailInput"
                placeholder="Ingrese su Correo"
                aria-describedby="emailHelp"
                onChange={(e) => setEmail(e.target.value)}
              />
              <label htmlFor="passLabel" className="text-title">
                Contraseña
              </label>
              <input
                type="password"
        ...
        <div>
          <center>
            <p className="align-text-bottom p-login">
              No posees una cuenta? Contacte con nostros
              <a target="popup" href="https://wa.me/595981383068">
                {' '}
                aquí
              </a>
            </p>
